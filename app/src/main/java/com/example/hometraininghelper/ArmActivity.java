...
/* 해당 액티비티 클래스는 홈트 운동 부위 중에 팔에 해당하는 부분이다. 이 액티비티를 통해 팔의 초급, 중급, 고급 운동으로 넘어갈 수 있다.
...
public class ArmActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_arm); // 현재 액티비티의 레이아웃을 activity_arm.xml로 설정한다.
        ...
        btn_easy = findViewById(R.id.basic); // 팔 초급
        ...
        btn_normal = findViewById(R.id.nor); // 팔 중급
        ...
        btn_hard = findViewById(R.id.high); // 팔 고급
