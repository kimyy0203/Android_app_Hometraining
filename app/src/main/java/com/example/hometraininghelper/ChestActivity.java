...
/* 해당 액티비티 클래스는 홈트 운동 부위 중에 가슴에 해당하는 부분이다. 이 액티비티를 통해 가슴의 초급, 중급, 고급 운동으로 넘어갈 수 있다.
...
public class ChestActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chest); // 현재 액티비티의 레이아웃을 activity_chest.xml로 설정한다.
        ...
        btn_easy = findViewById(R.id.basic); // 가슴 초급
        ...
        btn_normal = findViewById(R.id.nor); // 가슴 중급
        ...
        btn_hard = findViewById(R.id.high); // 가슴 고급
