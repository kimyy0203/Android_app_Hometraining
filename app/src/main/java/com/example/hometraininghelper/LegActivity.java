...
/* 해당 액티비티 클래스는 홈트 운동 부위 중에 다리에 해당하는 부분이다. 이 액티비티를 통해 다리의 초급, 중급, 고급 운동으로 넘어갈 수 있다.
...
public class LegActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_leg); // 현재 액티비티의 레이아웃을 activity_leg.xml로 설정한다.
