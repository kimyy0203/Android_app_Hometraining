...
/* 해당 액티비티 클래스는 홈트 운동 부위 중에 다리에 해당하는 초급 부분이다.
이 클래스는 특별한 동작 없이 단순히 다리 초급에 해당되는 레이아웃을 연결하여 관련된 유튜브 영상을 볼 수 있도록하며,
...
public class LegEasyActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    /* 해당 onCreate 메서드는 다리 초급에 해당되는 영상을 보여주는 레이아웃을 설정하여, 해당 영상을 볼 수 있도록한다.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leg_easy); // 현재 액티비티의 레이아웃을 activity_leg_easy.xml로 설정한다.
