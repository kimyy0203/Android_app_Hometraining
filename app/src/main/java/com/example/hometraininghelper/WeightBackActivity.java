...
/* 해당 액티비티 클래스는 웨이트 운동 부위 중에 등에 해당하는 부분이다. 이 액티비티를 통해 등의 운동 기구들로 넘어갈 수 있다.
...
public class WeightBackActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_back_weight); // 현재 액티비티의 레이아웃을 activity_back_weight.xml로 설정한다.
