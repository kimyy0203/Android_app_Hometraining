...
/* 해당 액티비티 클래스는 웨이트 운동 부위 중에 어깨에 해당하는 부분이다. 이 액티비티를 통해 어깨의 운동 기구들로 넘어갈 수 있다.
...
public class WeightShoulderActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    // 운동 기구 종류들
    Button btn_1; // 레터럴 레이즈
    Button btn_2; // 숄더 프레스
    Button btn_3; // 밀리터리 프레스
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_shoulder_weight);  // 현재 액티비티의 레이아웃을 activity_shoulder_weight.xml로 설정한다.
